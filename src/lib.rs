...
unsafe impl<T> SingularGeneric for JsRef<T> {
    type Repr = JsValue;
}
...
impl<T> JsRef<T> {
    ...
    #[cfg(feature = "serde-serialize")]
    #[deprecated = "causes dependency cycles, use `serde-wasm-bindgen` or `gloo_utils::format::JsValueSerdeExt` instead"]
    pub fn into_serde<U>(&self) -> serde_json::Result<U>
    where
        U: for<'a> serde::de::Deserialize<'a>,
    {
        let s = __wbindgen_json_serialize(self.as_ref());
    ...
    pub fn as_f64(&self) -> Option<f64> {
        __wbindgen_number_get(self.as_ref())
    }

    /// Tests whether this JS value is a JS string.
    #[inline]
    pub fn is_string(&self) -> bool {
        __wbindgen_is_string(self.as_ref())
    }
    ...
    pub fn as_string(&self) -> Option<String> {
        __wbindgen_string_get(self.as_ref())
    }
    ...
    pub fn as_bool(&self) -> Option<bool> {
        __wbindgen_boolean_get(self.as_ref())
    }

    /// Tests whether this JS value is `null`
    #[inline]
    pub fn is_null(&self) -> bool {
        __wbindgen_is_null(self.as_ref())
    }

    /// Tests whether this JS value is `undefined`
    #[inline]
    pub fn is_undefined(&self) -> bool {
        __wbindgen_is_undefined(self.as_ref())
    }
    ...
    pub fn is_symbol(&self) -> bool {
        __wbindgen_is_symbol(self.as_ref())
    }

    /// Tests whether `typeof self == "object" && self !== null`.
    #[inline]
    pub fn is_object(&self) -> bool {
        __wbindgen_is_object(self.as_ref())
    }

    /// Tests whether this JS value is an instance of Array.
    #[inline]
    pub fn is_array(&self) -> bool {
        __wbindgen_is_array(self.as_ref())
    }

    /// Tests whether the type of this JS value is `function`.
    #[inline]
    pub fn is_function(&self) -> bool {
        __wbindgen_is_function(self.as_ref())
    }

    /// Tests whether the type of this JS value is `bigint`.
    #[inline]
    pub fn is_bigint(&self) -> bool {
        __wbindgen_is_bigint(self.as_ref())
    }
    ...
    pub fn loose_eq(&self, other: &Self) -> bool {
        __wbindgen_jsval_loose_eq(self.as_ref(), other.as_ref())
    }
}

// TODO: Generic with NumberType bound where JsValue is NumberType
impl JsValue {
    ...
    pub fn checked_div(&self, rhs: &Self) -> Self {
        __wbindgen_checked_div(self, rhs).cast_unchecked()
    }
    ...
    pub fn pow(&self, rhs: &Self) -> Self {
        __wbindgen_pow(self, rhs).cast_unchecked()
    }
