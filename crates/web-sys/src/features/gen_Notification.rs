...
extern "C" {
    ...
    # [wasm_bindgen (static_method_of = Notification , getter , js_class = "Notification" , js_name = "permission")]
    ...
    # [wasm_bindgen (static_method_of = Notification , getter , js_class = "Notification" , js_name = "maxActions")]
