    ...
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        (quote! {
            ...
            const _: () = {
                ...
                #[automatically_derived]
                impl #generics AsRef<#rust_name #generics> for #rust_name #generics #where_clause {
                    #[inline]
                ...
                let non_class_generic_params: Vec<_> = all_generic_params
                    ...
                    .filter(|&&ident| {
                        !class_generic_params
                            .iter()
                            .any(|&class_ident| class_ident == ident)
                    })
                    .cloned()
                    .collect();
                    ...
                    generics
                        ...
                        .filter(|param| match param {
                            syn::GenericParam::Type(type_param) => {
                                !class_generic_params.iter().any(|&n| n == &type_param.ident)
                            }
                            _ => true,
                        })
                        .collect();
