...
extern "C" {
    ...
    pub fn from<T, I: Iterable<Item = T>>(val: &I) -> Result<Array<T>, JsValue>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/from)
    #[wasm_bindgen(static_method_of = Array, catch, js_name = from)]
    pub fn from_iterable_map<'a, T, I: Iterable<Item = T>, U>(
        val: &I,
        map: &ImmediateClosure<'a, dyn FnMut(T, u32) -> Result<U, JsError>>,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/fromAsync)
    #[wasm_bindgen(static_method_of = Array, catch, js_name = fromAsync)]
    pub fn from_async_map<'a, T, U, I: AsyncIterable<Item = T>, R: Promising<Resolution = U>>(
        val: &I,
        map: &ScopedClosure<'a, dyn FnMut(T, u32) -> Result<R, JsError>>,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat)
    #[wasm_bindgen(method)]
    pub fn concat_many<T>(this: &Array<T>, array: &[Array<T>]) -> Array<T>;
    ...
    pub fn try_every<'a, T>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(T, u32) -> Result<bool, JsError>>,
    ) -> Result<bool, JsValue>;
    ...
    pub fn find<'a, T>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(T, u32, Array<T>) -> bool>,
    ) -> Option<T>;
    ...
    pub fn try_flat_map<'a, T, U>(
        this: &Array<T>,
        callback: &ImmediateClosure<'a, dyn FnMut(T, u32) -> Vec<U>>,
    ) -> Result<Array<U>, JsValue>;
    ...
    pub fn try_for_each<'a, T>(
        this: &Array<T>,
        callback: &ImmediateClosure<'a, dyn FnMut(T, u32) -> Result<(), JsError>>,
    ) -> Result<(), JsValue>;
    ...
    pub fn try_map<'a, T, U>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(T, u32) -> Result<U, JsError>>,
    ) -> Result<Array<U>, JsValue>;
    ...
    pub fn reduce<'a, T, A>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(A, T, u32, Array<T>) -> A>,
        initial_value: &A,
    ) -> A;
    ...
    pub fn try_reduce<'a, T, A>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(A, T, u32) -> Result<A, JsError>>,
        initial_value: &A,
    ) -> Result<A, JsValue>;
    ...
    pub fn try_reduce_right<'a, T, A>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(JsValue, T, u32) -> Result<A, JsError>>,
        initial_value: &A,
    ) -> Result<A, JsValue>;
    ...
    pub fn try_some<'a, T>(
        this: &Array<T>,
        predicate: &ImmediateClosure<'a, dyn FnMut(T) -> Result<bool, JsError>>,
    ) -> Result<bool, JsValue>;
    ...
    pub fn try_sort_by<'a, T>(
        this: &Array<T>,
        compare_fn: &ImmediateClosure<'a, dyn FnMut(T, T) -> Result<i32, JsError>>,
    ) -> Result<Array<T>, JsValue>;
...
extern "C" {
    ...
    pub fn new_from_entries<K: JsGeneric, V: JsGeneric, I: Iterable<Item = ArrayTuple<(K, V)>>>(
        entries: &I,
    ) -> Map<K, V>;
    ...
    pub fn try_for_each<'a, K, V>(
        this: &Map<K, V>,
        callback: &ImmediateClosure<'a, dyn FnMut(V, K) -> Result<(), JsError>>,
    ) -> Result<(), JsValue>;
...
extern "C" {
    ...
    #[cfg(js_sys_unstable_apis)]
    #[wasm_bindgen(method, js_name = forEach)]
    pub fn for_each<'a, T>(this: &Set<T>, callback: &ImmediateClosure<'a, dyn FnMut(T)>);
    ...
    pub fn try_for_each<'a, T>(
        this: &Set<T>,
        callback: &ImmediateClosure<'a, dyn FnMut(T) -> Result<(), JsError>>,
    ) -> Result<(), JsValue>;
    ...
    extern "C" {
        ...
        pub fn stringify_with_replacer<'a>(
            ...
            replacer: &ImmediateClosure<
                'a,
                dyn FnMut(JsString, JsValue) -> Result<Option<JsValue>, JsError>,
            >,
            space: Option<u32>,
        ) -> Result<JsString, JsValue>;
...
extern "C" {
    ...
    pub fn all<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<Array<T>>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/all)
    #[wasm_bindgen(static_method_of = Promise, js_name = all)]
    pub fn all_iterable<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<Array<T>>;
    ...
    #[cfg(js_sys_unstable_apis)]
    #[wasm_bindgen(static_method_of = Promise, js_name = allSettled)]
    pub fn all_settled<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/allSettled)
    #[wasm_bindgen(static_method_of = Promise, js_name = allSettled)]
    pub fn all_settled_iterable<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<Array<PromiseState<T>>>;
    ...
    pub fn any<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<T>;
    ...
    #[cfg(not(js_sys_unstable_apis))]
    #[wasm_bindgen(static_method_of = Promise, js_name = any)]
    pub fn any_iterable<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<T>;
    ...
    pub fn race<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<T>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/race)
    #[wasm_bindgen(static_method_of = Promise, js_name = race)]
    pub fn race_iterable<T: JsGeneric, U: Promising<Resolution = T>, I: Iterable<Item = U>>(
        obj: &I,
    ) -> Promise<T>;
    ...
    pub fn resolve<T: JsGeneric, U: Promising<Resolution = T>>(obj: &U) -> Promise<T>;
    ...
    #[wasm_bindgen(method, js_name = catch)]
    pub fn catch_map<'a, T, R: Promising<Resolution = T>>(
        this: &Promise<T>,
    ...
    #[cfg(not(js_sys_unstable_apis))]
    #[wasm_bindgen(method)]
    pub fn then<'a, T>(this: &Promise<T>, cb: &ScopedClosure<'a, dyn FnMut(T)>) -> Promise<JsValue>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/then)
    #[wasm_bindgen(method, js_name = then)]
    pub fn then_with_reject<'a, T, U: JsGeneric, R: Promising<Resolution = U>>(
        this: &Promise<T>,
...
macro_rules! arrays {
    ($(#[doc = $ctor:literal] #[doc = $mdn:literal] $name:ident: $ty:ident,)*) => ($(
        ...
        extern "C" {
            ...
            /// types here.
            #[wasm_bindgen(method, js_name = forEach, catch)]
            pub fn try_for_each(this: &$name, callback: &ImmediateClosure<dyn FnMut($ty, u32, $name) -> Result<(), JsError>>) -> Result<(), JsValue>;
