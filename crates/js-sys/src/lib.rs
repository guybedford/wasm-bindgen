...
use wasm_bindgen::__rt::marker::SingularGeneric;
use wasm_bindgen::convert::FromWasmAbi;

pub use wasm_bindgen;
use wasm_bindgen::{prelude::*, Generic};
...
extern "C" {
    ...
    #[derive(Clone, Debug)]
    pub type ArrayTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>;
...
#[derive(Debug, Clone)]
pub struct ArrayIntoIter<T: SingularGeneric> {
    range: core::ops::Range<u32>,
    array: Array<T>,
}

impl<T: Generic<JsValue>> core::iter::Iterator for ArrayIntoIter<T> {
    type Item = T;
...
impl<T: Generic<JsValue>> core::iter::DoubleEndedIterator for ArrayIntoIter<T> {
...
impl<T: Generic<JsValue>> core::iter::FusedIterator for ArrayIntoIter<T> {}

impl<T: Generic<JsValue>> core::iter::ExactSizeIterator for ArrayIntoIter<T> {}

/// Iterator returned by `Array::iter`
#[derive(Debug, Clone)]
pub struct ArrayIter<'a, T: SingularGeneric> {
    range: core::ops::Range<u32>,
    array: &'a Array<T>,
}

impl<T: Generic<JsValue>> core::iter::Iterator for ArrayIter<'_, T> {
    type Item = T;
...
impl<T: Generic<JsValue>> core::iter::DoubleEndedIterator for ArrayIter<'_, T> {
    fn next_back(&mut self) -> Option<Self::Item> {
        let index = self.range.next_back()?;
        Some(self.array.get(index))
    }
...
impl<T: Generic<JsValue>> core::iter::FusedIterator for ArrayIter<'_, T> {}

impl<T: Generic<JsValue>> core::iter::ExactSizeIterator for ArrayIter<'_, T> {}

impl<T: Generic<JsValue>> Array<T> {
...
impl<T: Generic<JsValue>> core::iter::IntoIterator for Array<T> {
    type Item = T;
...
impl<A, T: Generic<JsValue>> core::iter::FromIterator<A> for Array<T>
where
    A: AsRef<T>,
{
...
impl<A, T: Generic<JsValue>> core::iter::Extend<A> for Array<T>
where
    A: AsRef<T>,
{
...
extern "C" {
    ...
    #[wasm_bindgen(method)]
    pub fn keys<T>(this: &Array<T>) -> Iterator;
    ...
    #[wasm_bindgen(method)]
    pub fn entries<T>(this: &Array<T>) -> Iterator;
...
pub trait TypedArray: Generic<JsValue> {}
...
/// Marker type for a void argument
pub struct Void;
...
extern "C" {
    ...
    #[derive(Clone, Debug, PartialEq, Eq)]
    pub type Function<Return, A1, A2, A3, A4, A5, A6, A7, A8, A9>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new<R>(body: &str) -> Function<R>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new1<R, A1>(arg1: &str, body: &str) -> Function<R, A1>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new2<R, A1, A2>(arg1: &str, arg2: &str, body: &str) -> Function<R, A1, A2>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new6<R, A1, A2, A3, A4, A5, A6>(
        arg1: &str,
        arg2: &str,
        arg3: &str,
        arg4: &str,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new7<R, A1, A2, A3, A4, A5, A6, A7>(
        arg1: &str,
        arg2: &str,
        arg3: &str,
        arg4: &str,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new8<R, A1, A2, A3, A4, A5, A6, A7, A8>(
        arg1: &str,
        arg2: &str,
        arg3: &str,
        arg4: &str,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    #[wasm_bindgen(constructor)]
    pub fn new9<R, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
        arg1: &str,
        arg2: &str,
        arg3: &str,
        arg4: &str,
    ...
    ///
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/apply)
    #[wasm_bindgen(method, catch, js_name = apply, variadic)]
    ...
    pub fn call0<R>(this: &Function<R>, context: &JsValue) -> Result<R, JsValue>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call1<R, A1>(this: &Function<R, A1>, context: &JsValue, arg1: &A1)
        -> Result<R, JsValue>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call2<R, A1, A2>(
        this: &Function<R, A1, A2>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
    ) -> Result<R, JsValue>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call3<R, A1, A2, A3>(
        this: &Function<R, A1, A2, A3>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
        arg3: &A3,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call4<R, A1, A2, A3, A4>(
        this: &Function<R, A1, A2, A3, A4>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
        arg3: &A3,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call5<R, A1, A2, A3, A4, A5>(
        this: &Function<R, A1, A2, A3, A4, A5>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
        arg3: &A3,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call6<R, A1, A2, A3, A4, A5, A6>(
        this: &Function<R, A1, A2, A3, A4, A5, A6>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
        arg3: &A3,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call7<R, A1, A2, A3, A4, A5, A6, A7>(
        this: &Function<R, A1, A2, A3, A4, A5, A6, A7>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
        arg3: &A3,
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/call)
    #[wasm_bindgen(method, catch, js_name = call)]
    pub fn call8<R, A1, A2, A3, A4, A5, A6, A7, A8>(
        this: &Function<R, A1, A2, A3, A4, A5, A6, A7, A8>,
        context: &JsValue,
        arg1: &A1,
        arg2: &A2,
        arg3: &A3,
...
extern "C" {
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Generator/next)
    #[wasm_bindgen(method, structural, catch)]
    pub fn next_void<T: FromWasmAbi>(this: &Generator<T>) -> Result<IteratorResult<T>, JsValue>;
    ...
    pub fn next_with_value<T: FromWasmAbi>(
        this: &Generator<T>,
        value: &T,
    ) -> Result<IteratorResult<T>, JsValue>;
    ...
    ///
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Generator/return)
    #[wasm_bindgen(method, structural, catch, js_name = "return")]
    ...
    ///
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Generator/throw)
    #[wasm_bindgen(method, structural, catch, js_name = throw)]
...
extern "C" {
    ...
    pub fn next<T: FromWasmAbi>(this: &Iterator<T>) -> Result<IteratorResult<T>, JsValue>;
}
...
extern "C" {
    ...
    ) -> Result<Promise<IteratorResult<T>>, JsValue>;
}
...
impl<'a, T: FromWasmAbi + Generic<JsValue>> IntoIterator for &'a Iterator<T> {
...
impl<T: FromWasmAbi + Generic<JsValue>> core::iter::Iterator for Iter<'_, T> {
    type Item = Result<T, JsValue>;
...
impl<T: FromWasmAbi + Generic<JsValue>> IntoIterator for Iterator<T> {
    type Item = Result<T, JsValue>;
...
impl<T: FromWasmAbi + Generic<JsValue>> core::iter::Iterator for IntoIter<T> {
    type Item = Result<T, JsValue>;
...
impl IterState {
    ...
    fn next<T: FromWasmAbi + Generic<JsValue>>(
        &mut self,
        js: &Iterator<T>,
...
extern "C" {
    ...
    /// altogether.
    #[wasm_bindgen(method, getter, structural)]
    pub fn done<T>(this: &IteratorResult<T>) -> bool;

    /// Any JavaScript value returned by the iterator. Can be omitted when done
    /// is true.
    #[wasm_bindgen(method, getter, structural)]
    pub fn value<T>(this: &IteratorResult<T>) -> T;
}
...
extern "C" {
    ...
    pub fn try_new_typed_with_init<T, I: Iterable<Item = T>>(init: &I) -> Result<Set<T>, JsValue>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set)
    #[wasm_bindgen(constructor, js_name = new)]
    pub fn new_from_items<T>(items: Box<[T]>) -> Set<T>;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set)
    #[wasm_bindgen(constructor, js_name = new)]
    pub fn new_from_iterable<T, I: Iterable<Item = T>>(iterable: I) -> Set<T>;
...
extern "C" {
    ...
    #[wasm_bindgen(method)]
    pub fn entries<T: SingularGeneric>(set: &Set<T>) -> Iterator;
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set/entries)
    #[wasm_bindgen(method, js_name = entries)]
    pub fn entries_typed<T: SingularGeneric>(set: &Set<T>) -> Iterator<ArrayTuple<T, T>>;
...
impl<T> Promising<T> for T {}
impl<T> Promising<T> for Promise<T> {}
...
extern "C" {
    ...
    pub fn all_iterable<T, I: Iterable<Item: Promising<T>>>(obj: &I) -> Promise<Array<T>>;
    ...
    pub fn reject_t<T>(obj: &JsValue) -> Promise<T>;
