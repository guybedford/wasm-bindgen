...
fn test_from_iterable_map() {
    ...
    let result: Array<Number> = Array::from_iterable_map(
        &source,
        &ImmediateClosure::new(&mut |val: Number, _idx: u32| {
...
fn test_array_try_filter() {
    ...
    let result = arr.try_filter(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() % 2 == 0)));
    assert!(result.is_ok());
...
fn test_array_try_find() {
    ...
    let result = arr.try_find(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() == 2)));
    assert!(result.is_ok());
    let found = result.unwrap();
    assert!(found.is_some());
    assert_eq!(found.unwrap().name(), "banana");

    let result = arr.try_find(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() == 99)));
    assert!(result.is_ok());
...
fn test_array_try_find_error() {
    ...
    let result = arr.try_find(&ImmediateClosure::new(&mut |_val: TestItem, _| Err(JsError::new("find error"))));
    assert!(result.is_err());
}
...
fn test_array_try_find_index() {
    ...
    let result = arr.try_find_index(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() == 2)));
    assert!(result.is_ok());
    assert_eq!(result.unwrap(), 1);

    let result = arr.try_find_index(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() == 99)));
    assert!(result.is_ok());
    assert_eq!(result.unwrap(), -1);
}
...
fn test_array_try_find_index_error() {
    ...
    let result = arr.try_find_index(&ImmediateClosure::new(&mut |_val: TestItem, _| Err(JsError::new("find_index error"))));
    assert!(result.is_err());
}
...
fn test_array_try_find_last() {
    ...
    let result = arr.try_find_last(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() > 1)));
    assert!(result.is_ok());
...
fn test_array_try_find_last_error() {
    ...
    let result = arr.try_find_last(&ImmediateClosure::new(&mut |_val: TestItem, _| Err(JsError::new("find_last error"))));
    assert!(result.is_err());
}
...
fn test_array_try_find_last_index() {
    ...
    let result = arr.try_find_last_index(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.id() > 1)));
    assert!(result.is_ok());
...
fn test_array_try_find_last_index_error() {
    ...
    let result = arr
        .try_find_last_index(&ImmediateClosure::new(&mut |_val: TestItem, _| Err(JsError::new("find_last_index error"))));
    assert!(result.is_err());
}
...
fn test_array_try_map() {
    ...
    let result: Result<Array<TestItem>, JsValue> =
        arr.try_map(&ImmediateClosure::new(&mut |val: TestItem, _| Ok(val.with_prefix(&JsString::from("pre_")))));
    assert!(result.is_ok());
...
fn test_array_try_map_error() {
    ...
    let result: Result<Array<TestItem>, JsValue> = arr.try_map(&ImmediateClosure::new(&mut |val: TestItem, _| {
        if val.id() == 2 {
...
fn test_array_try_reduce() {
    ...
    let result = arr.try_reduce(
        &ImmediateClosure::new(&mut |acc: Number, val: Number, _| Ok(Number::from(acc.value_of() + val.value_of()))),
        &initial,
    );
    assert!(result.is_ok());
...
fn test_array_try_some() {
    ...
    let result = arr.try_some(&ImmediateClosure::new(&mut |val: TestItem| Ok(val.id() == 2)));
    assert!(result.is_ok());
    assert!(result.unwrap());

    let result = arr.try_some(&ImmediateClosure::new(&mut |val: TestItem| Ok(val.id() == 99)));
    assert!(result.is_ok());
    assert!(!result.unwrap());
}
...
fn test_array_try_some_error() {
    ...
    let result = arr.try_some(&ImmediateClosure::new(&mut |_val: TestItem| Err(JsError::new("some error"))));
    assert!(result.is_err());
}
...
fn test_array_try_sort_by() {
    ...
    let result =
        arr.try_sort_by(&ImmediateClosure::new(&mut |a: TestItem, b: TestItem| Ok((a.id() as i32) - (b.id() as i32))));
    assert!(result.is_ok());
...
fn test_array_try_sort_by_error() {
    ...
    let result = arr.try_sort_by(&ImmediateClosure::new(&mut |_a: TestItem, _b: TestItem| Err(JsError::new("sort error"))));
    assert!(result.is_err());
}
...
fn test_array_try_to_sorted_by() {
    ...
    let result =
        arr.try_to_sorted_by(&ImmediateClosure::new(&mut |a: TestItem, b: TestItem| Ok((b.id() as i32) - (a.id() as i32))));
    assert!(result.is_ok());
    let sorted = result.unwrap();
    assert_eq!(unwrap_get!(sorted, 0).id(), 3);
    assert_eq!(unwrap_get!(sorted, 1).id(), 2);
...
fn test_array_try_to_sorted_by_error() {
    ...
    let result = arr
        .try_to_sorted_by(&ImmediateClosure::new(&mut |_a: TestItem, _b: TestItem| Err(JsError::new("to_sorted error"))));
    assert!(result.is_err());
}
